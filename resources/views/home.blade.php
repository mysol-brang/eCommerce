    ...
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="owl-carousel owl-theme">
          ...
          <a href="single-product.html">
            <div class="featured-item">
              <img src="{{asset('dist/img/item-02.jpg')}}" alt="Item 2">
          ...
          <a href="single-product.html">
            <div class="featured-item">
              <img src="{{asset('dist/img/item-03.jpg')}}" alt="Item 3">
          ...
          <a href="single-product.html">
            <div class="featured-item">
              <img src="{{asset('dist/img/item-04.jpg')}}" alt="Item 4">
          ...
          <a href="single-product.html">
            <div class="featured-item">
              <img src="{{asset('dist/img/item-05.jpg')}}" alt="Item 5">
              <h4>Morbi aliquet</h4>
              <h6>$55.00</h6>
            </div>
          </a>
          <a href="single-product.html">
            <div class="featured-item">
              <img src="{{asset('dist/img/item-06.jpg')}}" alt="Item 6">
              <h4>Urna ac diam</h4>
              <h6>$65.00</h6>
            </div>
          </a>
